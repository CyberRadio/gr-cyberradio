...
#ifndef INCLUDED_CYBERRADIO_THREAD_H
#define INCLUDED_CYBERRADIO_THREAD_H
	...
	namespace CyberRadio
	{
		...
		class Thread
		{
			public:
				 ...
				 * \param name The new class identifer for the thread.
				 */
...
#endif /* INCLUDED_CYBERRADIO_THREAD_H */
