...
#ifndef INCLUDED_CYBERRADIO_PYTHONESQUE_H
#define INCLUDED_CYBERRADIO_PYTHONESQUE_H
...
namespace gr
{
	...
	namespace CyberRadio
	{
		...
		public:
			...
			/*!
			 * Gets the base name (the file name itself, without leading path components) from the
			 * given file path.
			 *
			 * @param path
...
#endif /* INCLUDED_CYBERRADIO_PYTHONESQUE_H */
