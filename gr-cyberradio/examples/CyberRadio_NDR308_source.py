...
# Title: NDR308 Source Demo
# Author: CRS
# Description: CRS NDR308 Source Demo
# Generated: Tue Oct 27 16:05:48 2015
##################################################
...
class CyberRadio_NDR308_source(gr.top_block, Qt.QWidget):
    ...
    def set_wbddc2_rate(self, wbddc2_rate):
        ...
        self.CyberRadio_NDR308_source_0.set_wbddc2_param_list(["eth10", 40002, 1, self.wbddc2_rate, self.wbddc2_enable])
    ...
    def set_wbddc1_rate(self, wbddc1_rate):
        ...
        self.CyberRadio_NDR308_source_0.set_wbddc1_param_list(["eth10", 40001, 1, self.wbddc1_rate, self.wbddc1_enable])
    ...
    def set_tuner2_freq(self, tuner2_freq):
        ...
        self.CyberRadio_NDR308_source_0.set_tuner2_param_list([self.tuner2_enable, self.tuner2_freq * 1e6, self.tuner2_atten])
    ...
    def set_tuner1_freq(self, tuner1_freq):
        ...
        self.CyberRadio_NDR308_source_0.set_tuner1_param_list([self.tuner1_enable, self.tuner1_freq * 1e6, self.tuner1_atten])
