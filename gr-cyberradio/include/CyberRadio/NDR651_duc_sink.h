...
#ifndef INCLUDED_CYBERRADIO_NDR651_DUC_SINK_H
#define INCLUDED_CYBERRADIO_NDR651_DUC_SINK_H
...
namespace gr
{
	...
	namespace CyberRadio
	{
		...
		class CYBERRADIO_API NDR651_duc_sink : virtual public gr::sync_decimator
		{
			public:
				typedef boost::shared_ptr<NDR651_duc_sink> sptr;

				/*!
				 * \brief Creates an NDR651_duc_sink block.
				 *
				 ...
				 *    False.
				 *
				 * \return A boost::shared_ptr<NDR651_duc_sink> representing the
				 *    new block.
				 */
				static sptr make(
...
#endif /* INCLUDED_CYBERRADIO_NDR651_DUC_SINK_H */
